...
namespace SmartMix.Core.Common.WinApi
{
    public class ResultWin32
    {
        ...
        /// <summary>
        /// The attempt to count the address book indicates failed.
        /// </summary>
        ...
        /// <summary>
        /// The private manifest probed has crossed re-parse-point-associated path
        /// </summary>
    ...
    public class ResultCom
    {
        ...
        /// <summary>
        /// The certificate does not meet or contain the Authentiс Сode financial extensions.
        /// </summary>
        ...
        /// <summary>
        /// The message was re-queued or moved by a user not in the "QC Trusted User" role
        /// </summary>
